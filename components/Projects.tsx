  ...
  return (
    <>
      ...
      {paginatedProjects.length > 0 ? (
        <>
          <div className="w-11/12 lg:w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-12">
      ...
      <a 
        href="https://github.com/TatanLion?tab=repositories" 
        target="_blank"
        className="block text-center mt-10 text-base c-purple font-semibold hover:underline"
      >
